...
export const STANDARD_FLAT_OBJECT_METADATA_BUILDERS_BY_OBJECT_NAME = {
  ...
  }: Omit<CreateStandardObjectArgs<'appraisal'>, 'context' | 'objectName'>) =>
    createStandardObjectFlatMetadata({
      objectName: 'appraisal',
      dependencyFlatEntityMaps,
      context: {
        universalIdentifier: STANDARD_OBJECTS.appraisal.universalIdentifier,
        nameSingular: 'appraisal',
        namePlural: 'appraisals',
        labelSingular: i18nLabel(msg`Appraisal`),
        labelPlural: i18nLabel(msg`Appraisals`),
        description: i18nLabel(msg`An appraisal`),
        icon: 'IconFileDollar',
        isSearchable: true,
  ...
  property: ({
    ...
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        description: i18nLabel(msg`A subject property`),
        icon: 'IconHome',
        isSearchable: true,
        labelIdentifierFieldMetadataName: 'name',
      },
  ...
  compsearch: ({
    ...
    twentyStandardApplicationId,
    dependencyFlatEntityMaps,
  }: Omit<CreateStandardObjectArgs<'compsearch'>, 'context' | 'objectName'>) =>
    createStandardObjectFlatMetadata({
      objectName: 'compsearch',
      dependencyFlatEntityMaps,
      context: {
        universalIdentifier: STANDARD_OBJECTS.compsearch.universalIdentifier,
        nameSingular: 'compsearch',
        namePlural: 'compsearches',
        labelSingular: i18nLabel(msg`Compsearch`),
        labelPlural: i18nLabel(msg`Compsearches`),
        description: i18nLabel(
          msg`One per appraisal — the whole-collective comp analysis: compset roster, market rates, run summaries, and the final reconciled value.`,
        ),
        icon: 'IconListSearch',
        isSearchable: true,
        labelIdentifierFieldMetadataName: 'name',
  ...
  comparable: ({
    ...
    twentyStandardApplicationId,
    dependencyFlatEntityMaps,
  }: Omit<CreateStandardObjectArgs<'comparable'>, 'context' | 'objectName'>) =>
    createStandardObjectFlatMetadata({
      objectName: 'comparable',
      dependencyFlatEntityMaps,
      context: {
        universalIdentifier: STANDARD_OBJECTS.comparable.universalIdentifier,
        nameSingular: 'comparable',
        namePlural: 'comparables',
        labelSingular: i18nLabel(msg`Comparable`),
        labelPlural: i18nLabel(msg`Comparables`),
        description: i18nLabel(msg`Comparable sales`),
        icon: 'IconGitCompare',
        isSearchable: true,
        labelIdentifierFieldMetadataName: 'name',
      },
  ...
  report: ({
    ...
    twentyStandardApplicationId,
    dependencyFlatEntityMaps,
  }: Omit<CreateStandardObjectArgs<'report'>, 'context' | 'objectName'>) =>
    createStandardObjectFlatMetadata({
      objectName: 'report',
      dependencyFlatEntityMaps,
      context: {
        universalIdentifier: STANDARD_OBJECTS.report.universalIdentifier,
        nameSingular: 'report',
        namePlural: 'reports',
        labelSingular: i18nLabel(msg`Report`),
        labelPlural: i18nLabel(msg`Reports`),
        description: i18nLabel(msg`An appraisal report`),
  ...
  reportSection: ({
    ...
    CreateStandardObjectArgs<'reportSection'>,
    'context' | 'objectName'
  >) =>
    createStandardObjectFlatMetadata({
      objectName: 'reportSection',
      dependencyFlatEntityMaps,
      context: {
        universalIdentifier: STANDARD_OBJECTS.reportSection.universalIdentifier,
        nameSingular: 'reportSection',
        namePlural: 'reportSections',
        labelSingular: i18nLabel(msg`Report Section`),
        labelPlural: i18nLabel(msg`Report Sections`),
        description: i18nLabel(msg`A section of a report node graph`),
        icon: 'IconLayoutList',
        isSearchable: true,
        labelIdentifierFieldMetadataName: 'name',
      },
  ...
  reportNode: ({
    ...
    twentyStandardApplicationId,
    dependencyFlatEntityMaps,
  }: Omit<CreateStandardObjectArgs<'reportNode'>, 'context' | 'objectName'>) =>
    createStandardObjectFlatMetadata({
      objectName: 'reportNode',
      dependencyFlatEntityMaps,
      context: {
        universalIdentifier: STANDARD_OBJECTS.reportNode.universalIdentifier,
        nameSingular: 'reportNode',
        namePlural: 'reportNodes',
        labelSingular: i18nLabel(msg`Report Node`),
        labelPlural: i18nLabel(msg`Report Nodes`),
        description: i18nLabel(msg`A node in a report node graph`),
        icon: 'IconBinaryTree',
        isSearchable: true,
        labelIdentifierFieldMetadataName: 'name',
      },
  ...
  reportNodeEdge: ({
    ...
    CreateStandardObjectArgs<'reportNodeEdge'>,
    'context' | 'objectName'
  >) =>
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        labelPlural: i18nLabel(msg`Report Node Edges`),
        description: i18nLabel(msg`An edge between two report nodes`),
  ...
  artifact: ({
    ...
    twentyStandardApplicationId,
    dependencyFlatEntityMaps,
  }: Omit<CreateStandardObjectArgs<'artifact'>, 'context' | 'objectName'>) =>
    createStandardObjectFlatMetadata({
      objectName: 'artifact',
      dependencyFlatEntityMaps,
      context: {
        universalIdentifier: STANDARD_OBJECTS.artifact.universalIdentifier,
        nameSingular: 'artifact',
        namePlural: 'artifacts',
        labelSingular: i18nLabel(msg`Artifact`),
        labelPlural: i18nLabel(msg`Artifacts`),
        description: i18nLabel(
          msg`A collected supporting document with its file attachment`,
        ),
        icon: 'IconPaperclip',
        isSearchable: true,
        labelIdentifierFieldMetadataName: 'name',
  ...
  >) =>
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        description: i18nLabel(msg`A persons membership in a list`),
        icon: 'IconUser',
        isSystem: true,
        labelIdentifierFieldMetadataName: 'id',
      },
